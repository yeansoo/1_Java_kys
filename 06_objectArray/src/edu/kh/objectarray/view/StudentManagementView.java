...
public class StudentManagementView {
	...
	// 필드 == 멤버변수
	private Scanner sc = new Scanner(System.in); //private 쓰는 이유 = 캡슐화
	
	private StudentManagementService service=new StudentManagementService();
	
	// alt + shift + j : 툴팁용 주석 <-- 이거 개쩐다
	...
	public void updateStudent() {
		...
		switch(result) {
		case -1: System.out.println("입력된 값이 인덱스 범위를 초과했습니다. "); break;
		case 0: System.out.println("해당 인덱스에 학생 정보가 존재하지 않습니다.");break;
		case 1: System.out.println("수정되었습니다.");break;
		default:
		}
	}
