	...
	public void ex1() {
		...
		for(int row=0;row<arr.length;row++) {
			for(int col=0;col<arr[0].length;col++)
				System.out.printf("%d행 %d열 == %d",row, col,arr[row][col]);
		}		
	}
...
//		char input=sc.nextChar();
		// nextChar()는 존재하지 않음 -> Scanner는 char자료형 입력을 지원X		
	...
	public void ex3() {
		// 3행3열 int 2차원 배열에 난수를 대입
		// 단, 각각의 마지막 행/열은 각 행/열의 합
		// 마지막 행, 마지막 열을 전체 난수의 합
