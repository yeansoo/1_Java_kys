...
public class VariableExample2 {
	   public static void main(String[] argc) {
	      ...
	      int iNum;
	      // 정수값을 저장할 공간 4byte를 메모리에 할당하고
	      // 그 공간을 iNum이라 부르겠다. 
	      
	      long longNum;
	      // 정수값을 저장할 공간 8byte를 메모리에 할당하고
	      // 그 공간을 longNum이라 부르겠다. 
	      ...
	      // 1000000000은 int 표기법이므로 int의 최대 크기를 넘어설 수 없다.
	      // -> long 자료형의 리터럴 표깁ㅂ은 정수 뒤에 L 또는 l 작성
